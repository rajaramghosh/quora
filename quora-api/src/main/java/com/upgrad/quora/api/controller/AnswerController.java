...
/**
 * This Controller class is for the answer related endpoints
 */
@RestController
@RequestMapping("/")
public class AnswerController {
    ...
    public ResponseEntity<AnswerResponse> createAnswer(AnswerRequest answerRequest, @PathVariable("questionId") final String questionId,
        ...
        AnswerEntity answerEntity = answerBusinessService.createAnswer(authorizationToken, questionId, answerRequest.getAnswer());
     ...
     * @return ResponseEntity with appropriate response code
     * @throws AuthorizationFailedException
    ...
    public ResponseEntity<AnswerEditResponse> editAnswerContent(@RequestHeader("authorization") final String authorizationToken,
        ...
        AnswerEntity answerEntity = answerBusinessService.updateAnswer(authorizationToken, answerId, answerEditRequest.getContent());
    ...
    public ResponseEntity<AnswerDeleteResponse> deleteAnswer(@RequestHeader("authorization") final String authorizationToken,
        ...
        answerBusinessService.deleteAnswer(authorizationToken, answerId);
    ...
    public ResponseEntity<List<AnswerDetailsResponse>> getAllAnswersToQuestion (@RequestHeader("authorization") final String authorizationToken,
        ...
        List<AnswerEntity> answerEntityList = answerBusinessService.getAllAnswersToQuestion(authorizationToken, questionId);
